...
const title = 'User-centered digital experiences';
const description =
  'I am dedicated to creating interfaces that feel natural and accessible to the end-user. My goal is to build digital products that solve real-world problems.';
const roles = [
  'UX Strategy',
  'UI Design',
  'Prototyping',
